        ...
        for cell in cells:
            if no_multiplets is False or (no_multiplets is True 
                ...
                if cell.bgcolor is not None:
                    G.nodes[cell]['style'] = 'filled'
                    G.nodes[cell]['fillcolor'] = cell.bgcolor
    ...
    for locus in locus_names:
        ...
        if os.path.isfile(trinity_fasta):
            command = [igblast, '-germline_db_V', databases['V'], 
                      ...
                      '-query', trinity_fasta, '-auxiliary_data', '{}/optional_file/{}_gl.aux'.format(index_location,igblast_species)]
